...
extern "C"
{
	...
	_declspec(dllexport) int _cdecl xatlasAddMesh(void* atlas, 
	...
	_declspec(dllexport) void _cdecl xatlasParametrize(void* atlas)
	{
		xatlas::ChartOptions options;
		xatlas::ComputeCharts((xatlas::Atlas*)atlas, options);
		xatlas::ParameterizeCharts((xatlas::Atlas*)atlas);
	}
